...
<div id="show-utilisateur" class="content scaffold-show" role="main">
    ...
    <ol class="property-list utilisateur">
        ...
        <g:if test="${utilisateurInstance?.dateNaissance}">
            <li class="fieldcontain">
                <span id="dateNaissance-label" class="property-label"><g:message code="utilisateur.dateNaissance.label"
                                                                                 default="Date Naissance"/></span>

                <span class="property-value" aria-labelledby="dateNaissance-label"><g:formatDate
                        date="${utilisateurInstance?.dateNaissance}"/></span>
