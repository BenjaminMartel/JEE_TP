...
class InscriptionController {
    ...
    def doSearchInscriptions() {
        def liste = inscriptionService.searchInscriptions(params.titre,params.responsable, params.utilisateur)
        render(view: 'index', model: [inscriptionInstanceList: liste, inscriptionInstanceCount: liste.size()])
    }
